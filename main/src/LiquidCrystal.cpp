...
LiquidCrystal::LiquidCrystal(DigitalIoPin *rs,  DigitalIoPin *enable,
			     DigitalIoPin *d0, DigitalIoPin *d1, DigitalIoPin *d2, DigitalIoPin *d3, bool _auto_newline) : newline(_auto_newline)
{
  rs_pin = rs;
  enable_pin = enable;
...
{
  //Cursor control or Automatic newline  (Two different ways to use LCD)
  if (this->newline) {
